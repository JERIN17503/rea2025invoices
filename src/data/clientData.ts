...
// Premium Clients (4+ invoices) - Amounts are before VAT
export const premiumClients: ClientSummary[] = [
  ...
  { name: "Navitas / Murdoch University", invoiceCount: 65, totalAmount: 289103, category: 'premium', salesPersons: ["REENA"] },
  { name: "Gulftainer Company Limited", invoiceCount: 51, totalAmount: 107488, category: 'premium', salesPersons: ["REENA"] },
  { name: "GrokGlobal Services", invoiceCount: 15, totalAmount: 79097, category: 'premium', salesPersons: ["REENA"] },
  { name: "Deakin University (Merged)", invoiceCount: 7, totalAmount: 75000, category: 'premium', salesPersons: ["REENA"] },
  { name: "Hult Investments (Merged)", invoiceCount: 13, totalAmount: 57280, category: 'premium', salesPersons: ["REENA"] },
  { name: "Trane BVBA (Merged)", invoiceCount: 44, totalAmount: 41128, category: 'premium', salesPersons: ["REENA"] },
  { name: "Continental Middle East DMCC", invoiceCount: 7, totalAmount: 37612, category: 'premium', salesPersons: ["REENA"] },
  { name: "Logic Utilities District Cooling", invoiceCount: 18, totalAmount: 35948, category: 'premium', salesPersons: ["REENA"] },
  ...
  { name: "BNI Polaris", invoiceCount: 47, totalAmount: 22336, category: 'premium', salesPersons: ["BNI"] },
  ...
  { name: "Huxley Associates Global", invoiceCount: 9, totalAmount: 9214, category: 'premium', salesPersons: ["REENA"] },
  ...
  { name: "Indo Tausch Trading (Merged)", invoiceCount: 6, totalAmount: 5777, category: 'premium', salesPersons: ["REENA"] },
  { name: "M E A D Medical Supplies", invoiceCount: 7, totalAmount: 4098, category: 'premium', salesPersons: ["REENA"] },
  { name: "Unique World Business Centre", invoiceCount: 24, totalAmount: 2805, category: 'premium', salesPersons: ["REENA"] },
  { name: "Momentum Logistics LLC", invoiceCount: 10, totalAmount: 1854, category: 'premium', salesPersons: ["REENA"] },
  { name: "Supercad Trading L.L.C", invoiceCount: 6, totalAmount: 1310, category: 'premium', salesPersons: ["BNI"] },
];

// Normal/Regular Clients (2-5 invoices) - Amounts are before VAT
export const normalClients: ClientSummary[] = [
  { name: "CACOGES", invoiceCount: 3, totalAmount: 40694, category: 'normal', salesPersons: ["REENA"] },
  { name: "Stellar Advertising LLC", invoiceCount: 5, totalAmount: 28812, category: 'normal', salesPersons: ["REENA"] },
  { name: "Alef Education Consultancy", invoiceCount: 4, totalAmount: 18631, category: 'normal', salesPersons: ["REENA"] },
  ...
  { name: "Radiometer Medical ApS", invoiceCount: 4, totalAmount: 13667, category: 'normal', salesPersons: ["REENA"] },
  ...
  { name: "SECA GMBH & CO. KG", invoiceCount: 2, totalAmount: 6913, category: 'normal', salesPersons: ["ANAND"] },
  ...
  { name: "ARK Creators", invoiceCount: 4, totalAmount: 6054, category: 'normal', salesPersons: ["BNI"] },
  ...
  { name: "Avant FZ LLC", invoiceCount: 3, totalAmount: 5294, category: 'normal', salesPersons: ["BNI"] },
  { name: "Swiss Business Council", invoiceCount: 2, totalAmount: 5150, category: 'normal', salesPersons: ["REENA"] },
  { name: "Expert United Marine", invoiceCount: 2, totalAmount: 4823, category: 'normal', salesPersons: ["REENA"] },
  { name: "World Data Feasibility", invoiceCount: 3, totalAmount: 4294, category: 'normal', salesPersons: ["REENA"] },
  { name: "Al Rashed United DMCC", invoiceCount: 3, totalAmount: 4074, category: 'normal', salesPersons: ["REENA"] },
  { name: "Contitech Fluids Oil", invoiceCount: 3, totalAmount: 3944, category: 'normal', salesPersons: ["REENA"] },
  { name: "Emboss - FZCO", invoiceCount: 3, totalAmount: 3920, category: 'normal', salesPersons: ["REENA"] },
  ...
  { name: "Finhub Middle East", invoiceCount: 3, totalAmount: 2249, category: 'normal', salesPersons: ["REENA"] },
  ...
  { name: "EDGE Technical Solution", invoiceCount: 3, totalAmount: 1950, category: 'normal', salesPersons: ["BNI"] },
  { name: "Axis Workshop", invoiceCount: 3, totalAmount: 1926, category: 'normal', salesPersons: ["BNI"] },
  { name: "Lloyds Energy DMCC", invoiceCount: 5, totalAmount: 1894, category: 'normal', salesPersons: ["REENA"] },
  ...
  { name: "Oculus Middle East Contracting", invoiceCount: 2, totalAmount: 1474, category: 'normal', salesPersons: ["BNI"] },
  ...
  { name: "Kotug Middle East DMCC", invoiceCount: 2, totalAmount: 889, category: 'normal', salesPersons: ["REENA"] },
  ...
  { name: "Netision Global Technologies", invoiceCount: 3, totalAmount: 374, category: 'normal', salesPersons: ["REENA"] },
...
// One-Time Clients (1 invoice) - Amounts are before VAT
export const oneTimeClients: ClientSummary[] = [
  ...
  { name: "Mr. Mohamed Sinaj Sali", invoiceCount: 1, totalAmount: 9134, category: 'one-time', salesPersons: ["BNI"], description: "Notebook, PVC card, Plaques" },
  ...
  { name: "Church of South India", invoiceCount: 1, totalAmount: 3810, category: 'one-time', salesPersons: ["ANAND"], description: "Consultation Charges" },
  { name: "Ms. Ling", invoiceCount: 1, totalAmount: 3750, category: 'one-time', salesPersons: ["REENA"], description: "Envelopes and Card" },
  { name: "Applus RTD Gulf DMCC", invoiceCount: 1, totalAmount: 3674, category: 'one-time', salesPersons: ["REENA"], description: "Sunshade" },
  ...
  { name: "Lane Community College", invoiceCount: 1, totalAmount: 2474, category: 'one-time', salesPersons: ["REENA"], description: "Postcards, Flyers, Banner" },
  { name: "Vela Arc Real Estate", invoiceCount: 1, totalAmount: 2374, category: 'one-time', salesPersons: ["SREERAJ"], description: "Voucher Book" },
  ...
  { name: "Orience Documents Clearance", invoiceCount: 1, totalAmount: 1778, category: 'one-time', salesPersons: ["SREERAJ"], description: "Table Flags and Big flag" },
  { name: "Huron University at Western", invoiceCount: 1, totalAmount: 1774, category: 'one-time', salesPersons: ["REENA"], description: "Brochure and Transportation" },
  ...
  { name: "TAM Trading FZ-LLC", invoiceCount: 1, totalAmount: 1574, category: 'one-time', salesPersons: ["REENA"], description: "Brochure" },
  ...
  { name: "Mawarid Finance", invoiceCount: 1, totalAmount: 1274, category: 'one-time', salesPersons: ["REENA"], description: "Glass branding" },
  ...
  { name: "Ms. Latika Vieira", invoiceCount: 1, totalAmount: 874, category: 'one-time', salesPersons: ["BNI"], description: "Customised 2 tier Cake" },
  { name: "Umesh C K", invoiceCount: 1, totalAmount: 864, category: 'one-time', salesPersons: ["BNI"], description: "Wooden Plaque" },
  { name: "Ms. Sally Souleman", invoiceCount: 1, totalAmount: 815, category: 'one-time', salesPersons: ["REENA"], description: "Hoodies" },
  { name: "ORIGA General Contracting", invoiceCount: 1, totalAmount: 749, category: 'one-time', salesPersons: ["BNI"], description: "Business Card" },
  { name: "AARK Marketing Services", invoiceCount: 1, totalAmount: 734, category: 'one-time', salesPersons: ["BNI"], description: "Polo shirt" },
  ...
  { name: "Divi Digital Co LLC", invoiceCount: 1, totalAmount: 536, category: 'one-time', salesPersons: ["BNI"], description: "Polo Shirt" },
  ...
  { name: "V7 Electro World FZCO", invoiceCount: 1, totalAmount: 434, category: 'one-time', salesPersons: ["REENA"], description: "Business card" },
  ...
  { name: "ARKA Ventures", invoiceCount: 1, totalAmount: 374, category: 'one-time', salesPersons: ["BNI"], description: "Business card" },
  { name: "Trica Technical Works", invoiceCount: 1, totalAmount: 349, category: 'one-time', salesPersons: ["REENA"], description: "Designing Charges" },
  ...
  { name: "Waisl Digital", invoiceCount: 1, totalAmount: 294, category: 'one-time', salesPersons: ["REENA"], description: "Business card" },
  ...
  { name: "Mr. Ajesh Mohan", invoiceCount: 1, totalAmount: 275, category: 'one-time', salesPersons: ["BNI"], description: "Business cards" },
  { name: "Ms Krishma Gehani", invoiceCount: 1, totalAmount: 270, category: 'one-time', salesPersons: ["BNI"], description: "Ceramic mugs" },
  { name: "Mr. Edwin", invoiceCount: 1, totalAmount: 233, category: 'one-time', salesPersons: ["SREERAJ"], description: "Polo shirts" },
  ...
  { name: "Ecofuture General Trading", invoiceCount: 1, totalAmount: 174, category: 'one-time', salesPersons: ["BNI"], description: "Rollup Banner" },
  ...
  { name: "Green Pasture Technical", invoiceCount: 1, totalAmount: 143, category: 'one-time', salesPersons: ["REENA"], description: "Polo Shirts" },
  { name: "4C Integrated Communicators", invoiceCount: 1, totalAmount: 134, category: 'one-time', salesPersons: ["REENA"], description: "Polo shirt" },
  ...
  { name: "Mr. Sahendra Jaiswar", invoiceCount: 1, totalAmount: 94, category: 'one-time', salesPersons: ["BNI"], description: "Photo Frame" },
